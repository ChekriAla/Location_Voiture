...
public class List_par_marque extends AppCompatActivity {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < cars.length(); i++) {
                        ...
                        String marque = car.getString("marque");

                        if( marque.equals(data)){
